...
if (isset($_POST['submit'])) {
   ...
   if ($select_user->rowCount() > 0) {
      ...
      if (isset($_POST['remember'])) {
         // création des cookies pour l'email et le mot de passe
         setcookie('remember_email', $email, time() + 3600 * 24 * 7, '/'); // Cookie valable pendant une semaine
         setcookie('remember_password', $pass, time() + 3600 * 24 * 7, '/'); // Cookie valable pendant une semaine
      } else {
         // Si l'utilisateur ne choisit pas "Remember Me", supprimez les cookies s'ils existent
...
<head>
   ...
   <script>
      // JavaScript pour remplir les champs du formulaire avec les valeurs des cookies
      document.addEventListener("DOMContentLoaded", function () {
         var emailCookie = "<?php echo $cookie_email; ?>";
